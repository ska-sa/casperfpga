# -*- coding: utf-8 -*-
#
# casperfpga documentation build configuration file, created by
...
sys.path.append(os.path.abspath('../casperfpga'))
...
htmlhelp_basename = 'casperfpgadoc'
